...
def arg_parser():
    ...
    parser.add_argument('--lr_val', type=float, default = 0.01  ,help='learning rate')
    ...
    parser.add_argument('--nodes_per_layer', type=list, default = [256, 128, 64, 16]   ,help='nodes per layer')    
