...
csv_df, csv_path = create_CSV_for_outputs(output_folder, args) # iitializing the dataframe for csv or loading the previously used csv as a dataframe
...
if args.architecture_type is not None:
    all_csv_row_vals.append(args.architecture_type) # needed only when hyper-parameter tuning is being done
