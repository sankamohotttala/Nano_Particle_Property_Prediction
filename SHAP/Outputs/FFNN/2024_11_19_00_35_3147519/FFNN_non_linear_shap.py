...
shap.summary_plot(shap_values, features_test_df.iloc[:,:],max_display=num_features) # with actual feature names

shap.summary_plot(shap_values, features_test_df.iloc[:,:], plot_type="bar",max_display=num_features) #bar plot ; just average value of SHAP
...
shap.summary_plot(best_10, best_feature_10_df , max_display=num_features) # best 10%
shap.summary_plot(worst_10, worst_feature_10_df , max_display=num_features) # worst 10%
