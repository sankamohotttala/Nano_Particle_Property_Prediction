...
from shap_helper import col_names, dataframes_shap,residu_best_worst,residu_calc
import matplotlib
...
# plt.figure()
shap.summary_plot(shap_values, features_test_df.iloc[:,:], max_display=8, show=False)
plt.gcf().set_dpi(600)
...
shap.summary_plot(shap_values, features_test_df.iloc[:,:],max_display=8) # with actual feature names

shap.summary_plot(shap_values, features_test_df.iloc[:,:], plot_type="bar",max_display=8) #bar plot ; just average value of SHAP
...
shap.summary_plot(best_10, best_feature_10_df , max_display=8) # best 10%
shap.summary_plot(worst_10, worst_feature_10_df , max_display=8) # worst 10%
